...
public class OVRPlayerController : MonoBehaviour {
    ...
    protected virtual void UpdateController() {
        ...
        // Move contoller
         Controller.Move(moveDirection); // Bug: it doesn't work in avatar.
        ...
        ////// Move. 
        ////// Bug: Controller.Move() doesn't work.
        //if (Controller != null) {
        //    // transform.localRotation = Quaternion.identity;
        //    float moveSpeed = 2f;
        //    Vector3 axis = OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick);
        //    Vector3 moveVector = Vector3.zero;
        //    moveVector += (Vector3)(Controller.transform.right * axis.x);
        //    moveVector += (Vector3)(Controller.transform.forward * axis.y);
        //    moveVector = moveVector.normalized * moveSpeed * Time.deltaTime; 
        //    Controller.transform.Translate(moveVector);
        //}
    }
    ...
    public virtual void UpdateMovement() {
        ...
        if (EnableRotation) {
            ...
            if (RotateAroundGuardianCenter) {
                Controller.transform.rotation = Quaternion.Euler(euler);

            }
            else {
                Controller.transform.RotateAround(CameraRig.centerEyeAnchor.position, Vector3.up, euler.y);
            }
        }
#endif
    }
